...
import { AlertTriangle, Mailbox, ShieldCheck, Users } from "lucide-react";
...
export default async function AdminPage() {
  ...
  return (
    <div className="space-y-8">
      <SectionHeading
        eyebrow="Admin"
        title="Moderation and operational controls"
        description="The admin surface is structured for user management, reports, categories, tags, and audit logs."
      />
