    ...
    <section className="rounded-4xl border border-border/80 bg-card/80 p-5 sm:p-8">
      <div className="max-w-2xl">
        ...
        <p className="mt-2 text-sm text-muted">
          Use the form for support, campus collaborations, journal onboarding,
          or community questions. Messages are validated client-side and
          server-side before submission.
        </p>
      </div>

      {submission ? (
        <div className="mt-6 rounded-3xl border border-accent/20 bg-accent/8 p-4 sm:p-5">
            ...
            <div className="space-y-2 text-sm text-muted">
              <p className="font-medium text-foreground">
                {submission.userDelivered
                  ...
                  : submission.adminDelivered
                    ? "Your message was sent to the LexCircle support inbox."
              ...
              <div className="flex flex-wrap gap-2 text-[11px] uppercase tracking-[0.14em] sm:text-xs sm:tracking-[0.16em]">
                ...
                <span className="rounded-full border border-border/80 bg-background/70 px-3 py-1">
                  Admin delivery:{" "}
                  {submission.adminDelivered ? "sent" : "not sent"}
                </span>
                <span className="rounded-full border border-border/80 bg-background/70 px-3 py-1">
                  User delivery:{" "}
                  {submission.userDelivered ? "sent" : "not sent"}
                </span>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div className="space-y-2">
          ...
          >
            ...
            <option value="demo">Campus or journal demo</option>
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            placeholder="Law school, journal, society, chamber, or publication"
            className="w-full rounded-2xl border border-border/80 bg-background/80 px-4 py-3 outline-none focus:ring-4 focus:ring-ring"
          />
        ...
        <div className="space-y-2 lg:col-span-2">
          ...
          <input
            ...
            placeholder="Solo student, 12 journal members, 40 society members..."
            className="w-full rounded-2xl border border-border/80 bg-background/80 px-4 py-3 outline-none focus:ring-4 focus:ring-ring"
          />
        ...
        <div className="space-y-2 lg:col-span-2">
          ...
          <textarea
            ...
            rows={7}
            placeholder="Describe the issue, request, article workflow problem, or collaboration idea with enough context to be actionable."
            className="w-full rounded-3xl border border-border/80 bg-background/80 px-4 py-3 outline-none focus:ring-4 focus:ring-ring"
          />
